...
implementadas devido às prioridades definidas pelo autor e ao tempo disponível para o desenvolvimento. O foco principal foi direcionado para a melhoria da usabilidade e da experiência do usuário, em vez de introduzir novas funcionalidades.
...
a seção de \hyperref[sec:Detalhamento da Aplicacao]{Detalhamento da Aplicação} é apresentada para garantir uma adequada compreensão da aplicação Multilind. A seção de \hyperref[sec:Backlog de Melhorias]{\textit{Backlog} de Melhorias} apresenta uma lista priorizada das funcionalidades 
que guiaram o \hyperref[sec:Desenvolvimento do Aplicativo]{Desenvolvimento do Aplicativo}. E por fim têm-se as \hyperref[sec:Funcionalidades Implementadas]{Funcionalidades Implementadas}, que descreve as funcionalidades implementadas durante o desenvolvimento do aplicativo.
