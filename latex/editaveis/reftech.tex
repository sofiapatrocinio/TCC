...
e serviços que facilitam a criação, teste e a publicação de aplicativos multiplataforma.
...
Cada edição deste documento e do código-fonte da aplicação Multilind está sendo versionada por meio do Git e armazenados pelo GitHub. 
...
O Lucidchart \cite{lucidchart} é uma plataforma de criação de diagramas \textit{online} que permite criação, colaboração e compartilhamento de diagramas e atende várias notações, incluindo UML (\textit{Unified Modeling Language}) 
