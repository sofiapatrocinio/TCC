...
desenvolvimento e gerenciamento de versões.
...
\begin{table}[h]
    ...
    \resizebox{\columnwidth}{!}{\begin{tabular}{|l|l|l|}
        \hline
        \textbf{Nome}               & \textbf{Descrição}                                                     & \textbf{Link}                           \\ \hline
        LaTeX              & Ferramenta para escrita do documento                          & \href{https://www.latex-project.org/}{https://www.latex-project.org/} \\ \hline
        Docker             & Plataforma de virtualização de ambiente                       & \href{https://www.docker.com/}{https://www.docker.com/}       \\ \hline
        Visual Studio Code & Editor de código-fonte e de escrita do documento              & \href{https://code.visualstudio.com/}{https://code.visualstudio.com/} \\ \hline
        Git                & Versionamento de código-fonte e texto da monografia           & \href{https://git-scm.com/}{https://git-scm.com/}           \\ \hline
        GitHub             & Hospedagm dos repositórios da aplicação e monografia          & \href{https://github.com/}{https://github.com/}            \\ \hline
        React Native       & Framework que permite o desenvolvimento de aplicativos móveis & \href{https://reactnative.dev/}{https://reactnative.dev/}       \\ \hline
        Node.js            & Ambiente de execução do desenvolvimento back-end da aplicação & \href{https://nodejs.org/}{https://nodejs.org/}            \\ \hline
        Figma              & Ferramenta de design de interface de usuário                  & \href{https://www.figma.com/}{https://www.figma.com/}         \\ \hline
    \end{tabular}}
\end{table}