...
Usabilidade; a \hyperref[sec:Justificativa]{Justificativa} para realização deste trabalho, que consiste em refatorar um aplicativo já existente orientando-se por
...
O principal objetivo deste trabalho, visto como o Objetivo Geral, é a refatoração do aplicativo Multilind, procurando melhorá-lo em termos de experiência de usuário e
...
\begin{description}
    \item A fim de atingir o Objetivo Geral, pretende-se cumprir com os seguintes Objetivos Específicos:
          \begin{itemize}
              ...
              \item Condução da análise de resultados no aplicativo já refatorado, e
