...
são apresentados no Apêndice \ref{ApendiceA}. Em resumo, o processo para coleta desses dados foi com base nas opiniões dos \textit{stakeholders} dadas através de questionários.
...
\begin{description}
    \item Esta monografia está disposta em capítulos, conforme apresentado a seguir:
          \begin{itemize}
              \item Capítulo 2 - Referencial Teórico: apresenta os fundamentos teóricos do trabalho e conceitos relacionados às experiência de usuário e usabilidade.
