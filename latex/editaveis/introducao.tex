...
contribuir para a reprodução e a divulgação de línguas indígenas, adicionalmente, preservando e revitalizando-as. Este trabalho visou, portanto,
...
O presente trabalho conferiu insumos visando responder à seguinte questão de pesquisa:
...
representa pessoas indígenas, sendo necessárias validações considerando uma amostra desse público alvo e foco em experiência de usuário.  Ao longo dessa monografia, a questão 
de pesquisa é respondida, conferindo insumos comprobatórios ao leitor.
...
\begin{description}
    \item A fim de atingir o Objetivo Geral, procurou-se cumprir com os seguintes Objetivos Específicos:
          \begin{itemize}
...
\begin{description}
    \item Esta monografia está disposta em capítulos, conforme apresentado a seguir:
          \begin{itemize}
              ...
              \item \hyperref[chap:Aplicativo Multilind]{Capítulo 5 - Aplicativo Multilind}: apresenta o estudo de cunho exploratório realizado neste trabalho, procurando detalhá-lo em termos 
              de origem da ideia; público alvo; visão geral do aplicativo Multilind; pontos fortes que devem ser mantidos e fortalecidos; fraquezas que precisam ser corrigidas; requisitos, detalhamento 
              do desenvolvimento;

              \item \hyperref[chap:Análise dos Resultados]{Capítulo 6 - Análise de Resultados}: contempla os resultados dos testes de usabilidade e experiência do usuário no aplicativo Multilind. Adicionalmente, tem-se uma análise 
              detalhada dos resultados baseada nas métricas coletadas durante os testes de usabilidade e da aplicação do Questionário \textit{AttrakDiff}, e 

              \item \hyperref[chap:Conclusão]{Capítulo 7 - Conclusão}: confere uma retomada ao contexto geral em que a pesquisa foi desenvolvida, além de revelar o \textit{status} atual dos objetivos e questão de pesquisa propostos na primeira
              etapa do estudo; contribuições do projeto ao público e suas limitações; as impressões da autora acerca do trabalho, e um breve direcionamento para trabalhos futuros.
          \end{itemize}
\end{description}