...
\item O questionário conta com 28 itens que avaliam um produto em relação a quatro dimensões principais:
      \begin{itemize}
          \item Qualidade hedônica-estímulo: Indica a quantidade de suporte que o produto dá ao usuário para se 
          desenvolver, estimular e aumentar a motivação;

          \item Qualidade hedônica-identidade: Mede o grau de identificação da aplicação com o usuário;

          \item Qualidade pragmática: Avalia a qualidade de uma aplicação e mede o grau de sucesso e esforço que 
          os usuários têm ao utilizá-la para atingir seus objetivos.

          \item Qualidade pragmática: Avalia a qualidade de uma aplicação e mede o grau de sucesso e esforço que os 
...
termos melhor representa a sua experiência e em que nível.