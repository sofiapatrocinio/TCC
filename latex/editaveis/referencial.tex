...
da experiência de usuário. Por fim, têm-se as \hyperref[sec:Considerações Finais do Capítulo]{Considerações Finais}.
...
e útil para o público-alvo; fácil de aprender; auxiliar, em termos de eficácia e eficiência, nas tarefas que as pessoas desejam executar, e satisfatório de usar \cite{rubin2011}. 
...
\begin{table}[h]
    \centering
    \caption{Pares de palavras do Questionário AttrakDiff \cite{hassenzahl2003}}
    \label{tab02}
    \begin{tabular}{|c|ll|}
    \hline
...
No caso do presente trabalho, pretende-se usar testes de comparação para comparar a solução refatorada do aplicativo Multilind, orientando-se pela aplicação das heurísticas de Nielsen, com a solução inicial 
