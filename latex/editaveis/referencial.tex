...
Figura 1. Nesse caso, tem-se a Aline, 24 anos, estagiária, também da área de qualidade, atuante na equipe da gerente Ana. Admira 
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\textwidth]{figuras/persona.eps}
...
destina (i.e. não faz parte do público alvo). A Figura 2 ilustra uma típica antipersona, que difere do público alvo estabelecido anteriormente, 
de mulheres entre 20 e 35 anos, atuantes na área de TI.

\begin{figure}[h!]
	\centering
	\includegraphics[width=1\textwidth]{figuras/antipersona.eps}
